...
const Login = ({ onLoginSuccess }) => {
    ...
    const handleLogin = (e) => {
        ...
        switch (user.user_Type) {
            case "Administrator":
                navigate("/HomeAdmin", { state: { userEmail: user.email } });
                break;
            case "Manager":
            case "User":
            default:
                navigate("/newhome", { state: { userEmail: user.email } });
        }
    };
    ...
    return (
        <><div>
        <nav>
            <a href="#" className="logo" style={{textAlign:"center", justifyContent:"center"}}><span>AgroProLK</span></a>
